...
<body>
		...
		try {
            ...
            rs = st.executeQuery("select * from admin where id='"+id+"'");
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse" >
                    <ul class="nav navbar-nav"> <!-- style="border:orange;border-width:1px;border-style:solid; "-->
                        <!-- <li><a href="#" class="scroll-top" class="navbar-brand scroll-top"><b>Home</b></a></li> -->
                        <!-- <li><a href="#" class="scroll-link" data-id="about">About Us</a></li> -->
                        <li class="dropdown">
                        	<a><b>List</b></a>
                        	<div class="dropdown-content">
  								<a href="Registration_Template/index_AdminListArtist.jsp"><font size="2px"><b>ARTIST</b></font></a><br>
  								<a href="Registration_Template/index_AdminListCustomer.jsp"><font size="2px"><b>CUSTOMER</b></font></a><br>
							</div>
                        </li>
                        <li class="dropdown">
                        	<a><b>Add</b></a>
                        	<div class="dropdown-content">
  								<a href="Registration_Template/Admin_Registration.jsp"><font size="2px"><b>ADMIN</b></font></a><br>
  							</div>
                        </li>
                        <li class="dropdown">
                        	<a><b>Manage</b></a>
                        	<div class="dropdown-content">
  								<a href="#"><font size="2px"><b>ART</b></font></a><br>
  								<a href="#"><font size="2px"><b>ORDER REQUEST</b></font></a><br>
  								<a href="#"><font size="2px"><b>EXHIBITION</b></font></a><br>
							</div>
                        </li>
                        ...
                        <li class="dropdown">
  							...
  							<div class="dropdown-content">
  								...
  								<a href="#"><font size="2px"><b>EDIT PROFILE</b></font></a><br>
  								<!-- <a href="#"><font size="2px"><b>ORDER REQUEST</b></font></a> -->
  								<a href="Login_Template/index_AdminLogout.jsp"><font size="2px"><b>LOGOUT</b></font></a>
							</div>
                        </li>
                    </ul>
                </div>
