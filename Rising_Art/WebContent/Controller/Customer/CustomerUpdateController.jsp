...
//            int Id =Integer.parseInt(request.getParameter("id"));
            ...
            try 
            {
                ...
                rs = st.executeQuery("select * from customer");
               	...
               	status = st.executeUpdate("update customer set cname='"+name+"', c_date='"+date+"', gender='"+gender+"', email='"+email+"' ,phone='"+mobile+"' ,city='"+city+"' ,pincode='"+pincode+"' where customer_id='"+id+"'");
