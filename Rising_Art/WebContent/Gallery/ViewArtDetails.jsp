            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div class="text-center mb-5">
                        <a href=<%="\"index_ArtRequest.jsp?Id="+rs.getString(1)+"&artname="+rs.getString(2)+"&mid="+mid+"\"" %> class="btn btn-primary tm-btn-big">I'm Interested</a>
                    </div>      <%-- <%="\"index_ArtRequest.jsp?Id="+rs.getString(1)+"&artname="+rs.getString(2)+"&mid="+mid+"\"" %> --%>              
