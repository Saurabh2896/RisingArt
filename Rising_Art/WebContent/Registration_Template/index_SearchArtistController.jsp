...
<body>
	...
	<div class="heading">
		...
		<!-- <div class="container"> -->
			...
			<h3 style="text-align: right;padding-right:80px; float:right;"><a href="../Registration_Template/index_AdminListArtist.jsp"><font color="white">list</font></a></h3>
				<br>
        ...
        <form action="index_SearchArtistController.jsp" method="post"> 
         <center>
          <table>
         		<br><br><tr>
                          <td><input type="text" value="<%=search %>" id="search" name="search" placeholder="Enter Id or Name" style="-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;font-weight: bold" required=""/></td>
        ...
        <center>    
          ...
          <!-- <p align="center"> <font color="gray"><strong><b><i><u>List of Customers</b></i></u></strong></font></h2> -->
           ...
           try {
                ...
                rs = st.executeQuery("select * from artist where aname like '%"+search+"%' or artist_id like'%"+search+"%'");
