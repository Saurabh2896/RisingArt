...
<body>
	...
	<div class="heading">
				<h2>List of Art Requests</h2>
	</div>
		<!-- <div class="container"> -->
			<div class="heading">
			<h3 style="text-align: left;padding-left:80px; float:left;"><a href="../index_WelcomeArtistHome.jsp"><font color="white"> home</font></a></h3>
        ...
        <center>    
          ...
          <!-- <p align="center"> <font color="gray"><strong><b><i><u>List of Customers</b></i></u></strong></font></h2> -->
           <!--  <div style="overflow:scroll;height:324px;width:100%;overflow:auto"> -->
            ...
            <thread>             
            <tr bgcolor="crimson">
            <th><font color="white"><b>Request Id</b></th>
            <th><font color="white"><b>Art Id</b></th>
            <th><font color="white"><b>Art Name</b></th>
           ...
           try {
                ...
                rs = st.executeQuery("select * from art_request where artist_id='"+id+"'");
            ...
            <td><b><font color="black"><%=rs.getString("req_id") %></td>
            <td><b><font color="black"><%=rs.getString("artist_id") %></b></td>
            <td><b><font color="black"><%=rs.getString("art_name") %></b></td>
