...
<body>
	...
	<div class="heading">
		...
		<div class="container">
			<div class="heading">
			<h3 style="text-align: left;float:left;"><a href="../index_WelcomeCustomerHome.jsp"><font color="white"> back</font></a></h3>
            ...
            <div class="agile-form">
				...
				<form action="../Controller/Customer/CustomerUpdateController.jsp" method="post">
