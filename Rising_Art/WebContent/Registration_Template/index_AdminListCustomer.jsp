...
<body>
	...
	<div class="heading">
		...
		<!-- <div class="container"> -->
			...
			<!-- <h3 style="text-align: right;padding-right:80px; float:right;"><a href="../Login_Template/artist_login.html"><font color="white">login</font></a></h3> -->
				<br>
			...
			<%
                ...
                ResultSet rs;
            %>
            <form action="index_SearchCustomerController.jsp" method="post"> 
         <center>
          <table>
         		<br><br><tr>
        ...
        <center>    
          ...
          <!-- <p align="center"> <font color="gray"><strong><b><i><u>List of Customers</b></i></u></strong></font></h2> -->
           ...
           try {
            ...
            <td><b><font color="black"><%=rs.getString("customer_id") %></td>
            <td><b><font color="black"><%=rs.getString("cname") %></b></td>
            <td><b><font color="black"><%=rs.getString("c_date") %></b></td>
            ...
            <td><b><font color="black"><%=rs.getString("pincode") %></b></td>
